...
import {Gallery, OneGallery, GalleryPagination, GetGallery} from "./media.type";
...
export class MediaService
{
  ...
  private _gallery: BehaviorSubject<OneGallery | null> = new BehaviorSubject(null);
  ...
  get gallery$(): Observable<OneGallery> {
