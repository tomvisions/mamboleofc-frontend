...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.whoWeAreImageDesktop = this._imageService.loadImage1920x940('who-we-are-home.jpg');
    ...
    this.whoWeAreImageMobile = this._imageService.loadImage270x270('who-we-are-home.jpg');
